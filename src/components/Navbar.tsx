...
export default function Navbar() {
  ...
  return (
    <nav className="fixed left-0 right-0 top-0 z-[100] border-b border-border bg-canvas pt-[env(safe-area-inset-top)] backdrop-blur-md supports-[backdrop-filter]:bg-canvas/90">
